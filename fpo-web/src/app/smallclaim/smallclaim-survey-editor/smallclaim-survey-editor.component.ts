...
@Component({
  selector: 'app-smallclaim-survey-editor',
  templateUrl: './smallclaim-survey-editor.component.html',
  encapsulation: ViewEncapsulation.None,
  styleUrls: [
    '../../../../node_modules/surveyjs-editor/surveyeditor.css',
    './smallclaim-survey-editor.component.scss'
  ]
})
export class SmallclaimSurveyEditorComponent {
  ...
  ngOnInit() {
    ...
    console.log('surveyPath', this.surveyPath);
