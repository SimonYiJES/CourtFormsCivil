...
@Component({
  selector: 'app-smallclaim-survey-primary',
  templateUrl: './smallclaim-survey-primary.component.html',
  styleUrls: ['./smallclaim-survey-primary.component.scss']
})
export class SmallclaimSurveyPrimaryComponent implements OnInit {
