...
@Component({
  selector: 'app-smallclaim-survey',
  templateUrl: './smallclaim-survey.component.html',
  styleUrls: ['./smallclaim-survey.component.scss']
})

export class SmallclaimSurveyComponent {
  ...
  onNavigateToSmallClaim(): void {
    ...
    if (this.surveyModel.completeLastPage()) {
      if (userInfo !== '') {
        ...
        this.router.navigateByUrl('smallclaim/survey');
      } else {
