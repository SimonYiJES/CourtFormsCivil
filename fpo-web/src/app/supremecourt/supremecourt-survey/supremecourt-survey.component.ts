...
@Component({
  selector: 'app-supremecourt-survey',
  templateUrl: './supremecourt-survey.component.html',
  styleUrls: ['./supremecourt-survey.component.scss']
})

export class SupremecourtSurveyComponent {
  ...
  complete() {
   ...
   onNavigateToSupremeCout(): void {
    if (this.surveyModel.completeLastPage()) {
      this.router.navigateByUrl('supremecourt/survey')
    }
  }
